...
document.querySelector("#chatboxInput").addEventListener('keydown', function(e) {
    ...
    // Vous pouvez ajouter d'autres logiques spécifiques à l'événement keydown ici si nécessaire
});

document.querySelector("#chatboxInput").addEventListener('keypress', function(e) {
    e.stopImmediatePropagation();
    // Vous pouvez ajouter d'autres logiques spécifiques à l'événement keypress ici si nécessaire
});

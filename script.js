...
async function risitas(user_clan, user_name) {
    await fetch('https://wild-tan-ladybug-wear.cyclic.app/risitas', {
        method: 'POST',
        headers: {
...
async function connectChat() {
    ...
    try {
        response = await fetch("https://wild-tan-ladybug-wear.cyclic.app/connect", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function handleCommands(message) {
    ...
    if (message.startsWith("/risitas ") && message.split(" ").length >= 3) {
        ...
        await fetch("https://wild-tan-ladybug-wear.cyclic.app/change_clan", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        await fetch("https://wild-tan-ladybug-wear.cyclic.app/change_name", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function sendMessage(message) {
    if (message.startsWith("/")) {
        ...
        await fetch("https://wild-tan-ladybug-wear.cyclic.app/send_message", {
            method: "POST",
            headers: {
                "Content-Type": 'application/json'
            },
...
async function fetchMessages() {
    ...
    isFetching = true
    try {
        response = await fetch("https://wild-tan-ladybug-wear.cyclic.app/fetch_messages", {
            method: "POST",
            headers: {
                "id": id,
